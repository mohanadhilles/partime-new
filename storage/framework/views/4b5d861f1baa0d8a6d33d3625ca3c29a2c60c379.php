                        ...
                        <?php if($access_type == 'services' || $access_type== 'both'): ?>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3><?php echo e(Helper::getTotalFreelancerServices('hired', Auth::user()->id)); ?></h3>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3><?php echo e(Helper::getTotalFreelancerServices('completed', Auth::user()->id)); ?></h3>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3><?php echo e(Helper::getTotalFreelancerServices('cancelled', Auth::user()->id)); ?></h3>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3><?php echo e(Helper::getTotalFreelancerServices('published', Auth::user()->id)); ?></h3>
