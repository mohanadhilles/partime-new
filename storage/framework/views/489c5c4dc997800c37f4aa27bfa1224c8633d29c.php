    ...
    <div class="scroll-menu">
        <nav>
            ...
            <div class="btns">
                ...
                <a href="<?php echo e(url('login')); ?>" class="btn btn-blue-light login mb-2 d-block">تسجيل دخول</a>
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="main_menu">
                ...
                <div class="auth-action ml-auto">
                    ...
                    <a href="<?php echo e(url('login')); ?>" class="btn btn-blue-light login">تسجيل دخول</a>
                </div>
            </div>
        </nav>
    </div>
