...
<style>
    .available_jobs_section::before{ background-image: url("<?php echo e(asset('images/jobs_bg.png')); ?>");}
</style>
    <!-- main-hero-section -->
        ...
        <div class="container">
                ...
                <div class="search_wrap">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <a href="<?php echo e(url('guest/jobs')); ?>" class="btn btn-block btn-blue-light">عرض</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="available_jobs_list">
                <div class="row justify-content-md-center">
                     ...
                     <?php echo $__env->make('front-end.includes.functional_areas', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="text-center view-jobs-btn">
        <a href="<?php echo e(url('guest/jobs')); ?>" class="btn btn-pink">عرض جميع المهن <i class="fas fa-angle-double-left"></i></a>
    </div>
