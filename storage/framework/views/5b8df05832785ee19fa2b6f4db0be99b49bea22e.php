...
<?php $__env->startSection('content'); ?>
    <?php if($show_service_banner == 'true'): ?>
        ...
        <div class="wt-haslayout wt-innerbannerholder" style="background-image:url(<?php echo e(asset(Helper::getBannerImage($service_inner_banner, 'uploads/settings/general'))); ?>)">
            <div class="container">
