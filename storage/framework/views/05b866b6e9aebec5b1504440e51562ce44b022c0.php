									...
									<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php 
											...
											if ($order->type == 'job') {
												...
												$service_order = DB::table('service_user')->select('service_id')->where('id', $order->product_id)->first();
												$service = App\Service::find($service_order->service_id);
												$title = $service->title;
												$amount = $service->price;
												$attachment = Helper::getUnserializeData($service->attachments)[0];
